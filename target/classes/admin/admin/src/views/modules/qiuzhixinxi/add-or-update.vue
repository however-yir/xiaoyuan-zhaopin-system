	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item class="date" v-if="type!='info'" label="求职日期" prop="qiuzhiriqi" >
					<el-date-picker
						format="yyyy 年 MM 月 dd 日"
						value-format="yyyy-MM-dd"
						v-model="ruleForm.qiuzhiriqi" 
						type="date"
						:readonly="ro.qiuzhiriqi"
						placeholder="求职日期"
					></el-date-picker> 
				</el-form-item>
				<el-form-item class="input" v-else-if="ruleForm.qiuzhiriqi" label="求职日期" prop="qiuzhiriqi" >
					<el-input v-model="ruleForm.qiuzhiriqi" placeholder="求职日期" readonly></el-input>
				</el-form-item>
